...
std::ifstream input_file("uni_project_file.txt");
...
void calculateData(int id) {
    ...
    while (true) {
        ...
        if (ch == ' ' || ch == '\n') {
            value_keeper = std::stod(keeper);
            frame[i] = value_keeper;
            i++;
            keeper = "";
            if (ch == '\n')
                break;
    ...
    leftHigherARMAngle = (int) frame[0];
    rightHigherARMAngle = (int) frame[1];

    leftLowerARMAngle = (int) frame[2];
    rightLowerARMAngle = (int) frame[3];

    leftHigherLegAngle = (int) frame[4];
    rightHigherLegAngle = (int) frame[5];

    leftLowerLegAngle = (int) frame[6];
    rightLowerLegAngle = (int) frame[7];

    leftFootAngle = (int) frame[8];
    rightFootAngle = (int) frame[9];

    centerX = (GLfloat) frame[10];
    centerY = (GLfloat) frame[11];
    centerZ = (GLfloat) frame[12];

    vangle = (int) frame[13];

    // Change camera coordinates
    lookatx = (GLfloat) frame[14];
    lookaty = (GLfloat) frame[15];
    lookatz = (GLfloat) frame[16];
